...
public class FrmManteProd extends JFrame {
	...
	void llenaCombo() {
		...
		String slq = "select c from Categorias c";
		List<Categorias> lstCategorias = manager.createQuery(slq, Categorias.class).getResultList();
		
		cboCategorias.addItem("selecione.");
		...
		cboCategorias.addItem(c.getDescripcion());
		 ...
		 slq = "select p from Proveedor p";
		List<Proveedor> lstProveedor = manager.createQuery(slq, Proveedor.class).getResultList();
		
		cboProveedores.addItem("selecione.");
	...
	void registrar() {
	 ...
	 void aviso(String algo) {
		JOptionPane.showMessageDialog(this, algo, "Aviso de sistema", JOptionPane.INFORMATION_MESSAGE);
	...
	void listado() {
		...
		for(Productos u : lstProducto) {
			...
			imprimir("Descuento    :" + u.getDes_prod());
			imprimir("Stock        :" + u.getStk_prod() );
			imprimir("Precio       :" + u.getPre_prod());
			imprimir("Idcategoria  :"+ u.getObjcategoria().getDescripcion());
			imprimir("Estado       :" + u.getEst_prod());
			imprimir("idProveedor  :" + u.getIdproveedor() + " " + u.getObjproveedor().getNombre_rs());
			imprimir("........................................................");
		}
